    ...
    <Layout>
      <div className="h-full p-4 flex flex-col space-y-4">
        ...
        <div className="flex flex-nowrap whitespace-nowrap items-center gap-4 bg-black/60 backdrop-blur-md border border-white/20 rounded-2xl p-4 mb-2 overflow-x-auto">
          ...
          {/* Export Button */}
          <button className="ml-auto inline-flex items-center bg-white text-black py-2 px-4 rounded-4xl hover:bg-gray-100 transition-colors space-x-2">
            <Image
                  ...
                  {headers.map((h, i) => (
                    <th
                      ...
                      className={`px-4 py-3 text-left
                                       border-t border-b border-[#33C6F4]
                                       ${
                                         i < headers.length - 1
                                           ? "border-r border-[#33C6F4]"
                                           : ""
                                       }`}
                    >
                      {h}
